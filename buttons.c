...
// P.J. Bones UCECE
//
//Modified by Jaime, Ellis and Zoren for the Helicopter project
// 
...
void ButtonIntHandler(void)
{
    ...
    if (operational && calibrated)
    {
        if (checkButton(LEFT) == PUSHED)
        {
            desiredYaw -= TAIL_INCREMENT;
        }
        ...
        {
            if (desiredHeight <= MAIN_MAX)
            {
                desiredHeight += MAIN_INCREMENT;    //Set upper bound of heli
            }
        }
        if (checkButton(DOWN) == PUSHED)
        {
            if (desiredHeight >= MAIN_MIN)
            {     //Set lower bound of heli
                desiredHeight -= MAIN_INCREMENT;
            }
        }
    }
}
...
//*************************************************************************
// Button interrupt initialisation
//*************************************************************************
void ButtonIntInit(void)
{
    ...
    GPIOIntRegister(GPIO_PORTD_BASE, ButtonIntHandler);
    GPIOIntRegister(GPIO_PORTE_BASE, ButtonIntHandler);
