...
//
// P.J. Bones UCECE
// Edited by Jaime, Zoren and Ellis for the heli project
...
#define MAIN_INCREMENT 10
#define TAIL_INCREMENT 15
...
// *******************************************************
// Interrupt handler for heli control buttons
void
ButtonIntHandler(void);

// *********************************************************
// Initialiser for the button interrupt
void
ButtonIntInit(void);
